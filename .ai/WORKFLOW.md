...
Step 0.2: Ideation (if PROJECT.md does not exist)
  ...
  │
  ├── [REQUIRED INFORMATION — explore each area]
  ...
  │   ├── Technical Stack: Languages, frameworks, databases, hosting,
  │   │   third-party services. If unsure, propose options with tradeoffs.
...
Step 0.3: Project Initiation
  ...
  │   │   milestone → feature → task (each task small enough for one session)
